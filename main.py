...
print(is_literal(Not(Not(Atom('q')))))
print('\n')
print(is_clause(Not(Or(Or(Atom('p'), Not(Atom('q'))), Atom('r')))))
print(is_cnf(And(Atom('p'), Or(Atom('p'), Not(Atom('q'))))))
print(is_term(Not(And(And(Atom('p'), Not(Atom('q'))), Atom('z')))))
print(is_dnf(Or(Atom('p1'), And(Atom('p2'), Not(Atom('p3'))))))
